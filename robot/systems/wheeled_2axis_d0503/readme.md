...
```bash
python -m robot.systems.wheeled_2axis_d0503.apps.balance_serial --motor-mode serial --motor-port COM8 --imu-mode usb --imu-port COM3 --max-speed 400 --kp 18 --kd 0.35
```
...
```bash
python -m robot.systems.wheeled_2axis_d0503.apps.balance_serial --motor-mode serial --motor-port COM8 --imu-mode usb --imu-port COM3 --max-speed 800 --kp 60 --kd 0.35
```
